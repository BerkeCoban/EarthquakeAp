...
public class NotificationBody {
    ...
    public NotificationBody(boolean validateOnly, Message message) {
    ...
    public static class Builder{
        ...
        public NotificationBody build(){
            ClickAction clickAction = new ClickAction(1,"com.Huw.demoapp.intent.action.test");
           // SetButton[] btnArr =
    ...
    public static class AndroidNotification{
      ...
      //  private String image;
        ...
        //,ClickAction clickAction,SetButton[] setButton  constructor values
